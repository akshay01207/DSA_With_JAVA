...
basic salary (an integer) and the grade (an uppercase character), and depending upon which
...
*/
		...
		double roundAns = Math.round(totalSalary);
		int result = (int) (roundAns);
